...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id', 'film_work_id', 'genre_id', name='unique_film_work_genre_role_idx'),
    schema='content'
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id', 'film_work_id', 'person_id', 'role', name='film_work_person_role_idx'),
    schema='content'
    )
